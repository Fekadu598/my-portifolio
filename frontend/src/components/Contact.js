    ...
    <section className="section" id="contact">
      ...
      <div className="contact-inner fade-in">
        ...
        <div className="contact-socials">
          <a href="#" className="contact-social" title="GitHub">
      ...
      <div className="contact-form-card fade-in">
        <form className="contact-form" onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <textarea id="message" name="message" rows="4" required placeholder="Tell me about your project..." value={form.message} onChange={handleChange} />
          </div>
          <button type="submit" className="btn btn-lg btn-primary" style={{ width: '100%' }} disabled={status === 'loading'}>
